...
public class SelectorTest {
    ...
    public void setUp() throws Exception {
        ...
        this.selector = new Selector(5000L, this.metrics, time, "MetricGroup", channelBuilder, new LogContext());
    ...
    @Test
    public void testNodeResolvesToMultipleDNSRecords() throws Exception {
        ...
        selector = new Selector(5000L, metrics, time, "MetricGroup", channelBuilder, new LogContext()) {
            @Override
            public void connect(Node node, int sendBufferSize, int receiveBufferSize) throws IOException {
                ...
                connectImpl(new NodeAddressIterator(node, sendBufferSize, receiveBufferSize, addresses));
            }
        };
    ...
    public void registerFailure() throws Exception {
        ...
        Selector selector = new Selector(5000L, new Metrics(), new MockTime(), "MetricGroup", channelBuilder, new LogContext());
    ...
    public void testImmediatelyConnectedCleaned() throws Exception {
        ...
        Selector selector = new Selector(5000L, metrics, time, "MetricGroup", channelBuilder, new LogContext()) {
            @Override
